...
function newOperate(operate, mapOperateItems) {
    const attachmentFind = mapOperateItems.find(o => o.code == operate['attachment'].code)
    const checkerFind = mapOperateItems.find(o => o.code == operate['checker'].code)
    const powerFind = mapOperateItems.find(o => o.code == operate['power'].code)
    return {
        attachment: {
            ...operate['attachment'],
